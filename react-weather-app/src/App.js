    ...
    <div className="app">
      ...
      <div className="container">
        ...
        <div className="card mt-3 mx-auto">
          {/* Isit true data coming in from open weather based on input location */}
          {apiData.main
          ? (<div class="card-body text-center">
            ...
            <p className="h5">
              <FontAwesomeIcon 
              icon={faMapMarkerAlt}
              className="fas fa-1x mr-2 test-dark"
              /> {' '}
            ...
            <div className="row mt-4">
              <div className="col-md-6">
                <p>
                  ...
                  /> {' '}
                  <strong>
                  {kelvinToFarenheit(apiData.temp_min)}&deg; F
                  </strong>
                </p>
                <p>
                  <FontAwesomeIcon 
                  ...
                  /> {' '}
                  <strong>
                  {kelvinToFarenheit(apiData.temp_max)}&deg; F
                  </strong>
                </p>
              </div>
              <div className="col-md-6">
